...
select t1.event_cid,
       ...
       t3.mobile_bind_bankcardno_1m_hf,
       t4.certno_bind_cid_1m_hf,
       t5.bankcardno_bind_cid_1m_hf
from
    (select event_cid
     from cid_first_loan) t1
left outer join cid_bind_bankcardno_derived_1m_hf as t2 on t1.event_cid = t2.event_cid
left outer join mobile_bind_bankcardno_derived_1m_hf as t3 on t1.event_cid = t3.event_cid
left outer join certno_bind_cid_derived_1m_hf as t4 on t1.event_cid = t4.event_cid
left outer join bankcardno_bind_cid_derived_1m_hf as t5 on t1.event_cid = t5.event_cid;