...
select t1.event_cid,
       t1.event_certNo,
       t2.certno_dist_cid_3m_am,
       t2.certno_dist_mobile_3m_am,
       t2.certno_dist_bankCardNo_3m_am,
       t2.certno_dist_bankCardMobile_3m_am,
       t2.certno_dist_deviceId_3m_am,
       t2.certno_dist_imei_3m_am,
       t2.certno_dist_idfa_3m_am
from
    (select event_cid,
            event_certNo,
            collector_tstamp
...
select t1.event_cid,
       t1.event_mobile,
       t2.mobile_dist_certNo_3m_am,
       t2.mobile_dist_cid_3m_am,
       t2.mobile_dist_bankCardNo_3m_am,
       t2.mobile_dist_deviceId_3m_am,
       t2.mobile_dist_imei_3m_am,
       t2.mobile_dist_idfa_3m_am
from
    (select event_cid,
            event_mobile,
            collector_tstamp
...
select t1.event_cid,
       t1.event_bankCardNo,
       t2.bankCardNo_dist_cid_3m_am,
       t2.bankCardNo_dist_mobile_3m_am,
       t2.bankCardNo_dist_deviceId_3m_am,
       t2.bankCardNo_dist_imei_3m_am,
       t2.bankCardNo_dist_idfa_3m_am
from
    (select event_cid,
            event_bankCardNo,
            collector_tstamp
...
select t1.event_cid,
       ...
       t2.bankCardMobile_dist_centNo_3m_am,
       t2.bankCardMobile_dist_cid_3m_am,
       t2.bankCardMobile_dist_bankCardNo_3m_am,
       t2.bankCardMobile_dist_deviceId_3m_am,
       t2.bankCardMobile_dist_imei_3m_am,
       t2.bankCardMobile_dist_idfa_3m_am
from
    (select event_cid,
            event_bankCardMobile,
            collector_tstamp
...
(select t3.event_bankCardMobile,
       t3.collector_tstamp,
       size(collect_set(t4.event_certNo)) as bankCardMobile_dist_centNo_3m_am,
...
create table cid_derived_3m_am_all as
select t0.event_cid,
       t1.certno_dist_cid_3m_am,
       t1.certno_dist_mobile_3m_am,
       t1.certno_dist_bankCardNo_3m_am,
       t1.certno_dist_bankCardMobile_3m_am,
       t1.certno_dist_deviceId_3m_am,
       t1.certno_dist_imei_3m_am,
       t1.certno_dist_idfa_3m_am,
       t2.cid_dist_bankCardNo_3m_am,
       t2.cid_dist_bankCardMobile_3m_am,
       t2.cid_dist_deviceId_3m_am,
       t2.cid_dist_idfa_3m_am,
       t2.cid_dist_imei_3m_am,
       t3.mobile_dist_cid_3m_am,
       t3.mobile_dist_certNo_3m_am,
       t3.mobile_dist_bankCardNo_3m_am,
       t3.mobile_dist_deviceId_3m_am,
       t3.mobile_dist_idfa_3m_am,
       t3.mobile_dist_imei_3m_am,
       ...
       t5.bankCardMobile_dist_cid_3m_am,
       t5.bankCardMobile_dist_centNo_3m_am,
       t5.bankCardMobile_dist_bankCardNo_3m_am,
       t5.bankCardMobile_dist_deviceId_3m_am,
       t5.bankCardMobile_dist_idfa_3m_am,
       t5.bankCardMobile_dist_imei_3m_am
from
    (select event_cid
     from cid_first_loan) t0
left outer join cid_certNo_derived_3m as t1 on t0.event_cid = t1.event_cid
left outer join cid_derived_3m as t2 on t0.event_cid = t2.event_cid
